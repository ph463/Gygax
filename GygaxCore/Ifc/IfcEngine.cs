...
namespace IfcEngine
{
    class x64
    {
        ...
        public const string IFCEngineDLL = @"Ifc/IFCEngine.dll";
        ...
        // Seems to have problems with the float array, use the second version which passes the indices as Int64 array
